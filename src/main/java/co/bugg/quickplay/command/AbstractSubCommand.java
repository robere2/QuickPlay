...
public abstract class AbstractSubCommand {
    ...
    public ITextComponent getFormattedHelp() {
        ...
        command.appendText(getParent().getName());
        command.appendText(" ");
        ...
        commandStyle.setClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/" + getParent().getName() + " " + getName() + " "));
    ...
    public ITextComponent getFormattedUsage() {
        ...
        message.appendText("/");
        message.appendText(getParent().getName());
        message.appendText(" ");
