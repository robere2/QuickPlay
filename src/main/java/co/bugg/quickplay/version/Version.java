...
public class Version implements Comparable<Version> {
     ...
     */
    public static IChatComponent createChatMessage(Version version) {
        IChatComponent message = new ChatComponentText("");

        IChatComponent dynamicInfo = new ChatComponentText(Reference.MOD_NAME + " v" + version.toString() + " ")
                .setChatStyle(new ChatStyle().setColor(EnumChatFormatting.AQUA));

        IChatComponent staticMessage = new ChatComponentTranslation("quickplay.version.notification")
