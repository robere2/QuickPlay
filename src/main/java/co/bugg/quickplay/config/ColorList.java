...
public class ColorList extends AbstractConfigList {
    ...
    public void addButtons() {
        ...
        while(i < getSize()) {
            ...
            buttonWidth = 200;
            button = new GuiButton(i, 0, 0, buttonWidth, buttonHeight, new TextComponentTranslation("quickplay.color.name." + colors.get(i).getUnlocalizedName()).getUnformattedText());
