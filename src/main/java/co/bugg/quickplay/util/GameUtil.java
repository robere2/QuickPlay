...
public final class GameUtil {
    ...
    public static String getTextWithEllipsis(int width, String text) {
        ...
        if(width > Minecraft.getMinecraft().fontRenderer.getStringWidth(text) + margins) return text;
        ...
        int charIndex = 0;
        while(width > Minecraft.getMinecraft().fontRenderer.getStringWidth(builder.toString() + ellipsis) + margins) {
